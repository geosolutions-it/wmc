...
public class WMCMock implements WMCFacade {
    ...
    private final int DISCONNECT_DELAY = 500;
    private final int READ_CONFIG_DELAY = 2000;
    ...
    public boolean clear(final int week_day_index) {
        ...
        readResult.week_Slot1[week_day_index] = 0;
        readResult.week_Slot2[week_day_index] = 0;
