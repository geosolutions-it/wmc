package it.geosolutions.android.wmc.model;
...
public class Configuration {
    ...
    /**
     * TODO this is used by device too
     * Constructor used when a configuration is created from xml
     * It sets some invalid default values, which need to be overwritten by the xml
     * otherwise subsequent validation will fail if it finds a negative value
     */
